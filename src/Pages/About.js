                ...
                <div className="space-y-3 ">
                    ...
                    <div className="space-y-3 xl:flex flex-col hidden">
                        ...
                        <div className="xl:flex  justify-between items-center gap-10 my-10 ">
                            <div className="w-[100%]"><h1 className="text-[20px] 2xl:text-2xl  font-bold">"Where Faith and Knowledge Unite, Empowering Transformational Journeys."</h1></div>
                            <div className="">
                                <div className="bg-black h-[20vh] w-[1px] opacity-50"></div>
                            </div>
                            <div className="w-[100%]"><h1 className="text-[20px] 2xl:text-2xl  font-bold">"At Peacehouse University, education isn't just a pursuit; it's a pilgrimage of the heart and mind."</h1></div>
                            <div className="">
                                <div className="bg-black opacity-40 h-[20vh] w-[1px] "></div>
                            </div>
                            <div className="w-[100%]"><h1 className="text-[20px] 2xl:text-2xl  font-bold">"From classrooms to communities, we're committed to building bridges of compassion and understanding."</h1></div>
                        </div>
                    </div>
                </div>
            </div>
